...
<style>
  ...
  /* Force ALL text white/bright on dark background */
  .stApp p, .stApp span, .stApp div, .stApp label,
  .stApp li, .stApp td, .stApp th, .stApp small,
  [data-testid="stMarkdownContainer"] p,
  [data-testid="stMarkdownContainer"] li { color: #E2E8F0 !important; font-size: 1rem !important; line-height: 1.7 !important; }

  /* Headings - white, large, bold */
  .stApp h1 { color: #FFFFFF !important; font-size: 2.3rem !important; font-weight: 800 !important; margin-bottom: .5rem; letter-spacing: -.02em; }
  .stApp h2 { color: #FFFFFF !important; font-size: 1.6rem !important; font-weight: 700 !important; }
  .stApp h3 { color: #F1F5F9 !important; font-size: 1.25rem !important; font-weight: 600 !important; }
  .stApp h4 { color: #E2E8F0 !important; font-size: 1.05rem !important; font-weight: 600 !important; }

  /* Italic subtitle lines */
  .stApp em, [data-testid="stMarkdownContainer"] em { color: #94A3B8 !important; font-size: .97rem !important; }

  /* KPI cards */
  .kpi-card { background: linear-gradient(135deg,#0D1B3E,#0F2050); border: 2px solid #2D4A8A; border-radius: 16px; padding: 1.5rem 1rem; text-align: center; box-shadow: 0 6px 24px rgba(0,0,0,.5); }
  .kpi-value { font-size: 2.3rem !important; font-weight: 800 !important; margin: .3rem 0; letter-spacing: -.03em; line-height: 1.1; }
  .kpi-label { font-size: .78rem !important; color: #94A3B8 !important; text-transform: uppercase; letter-spacing: .12em; font-weight: 700 !important; }
  .kpi-delta { font-size: .9rem !important; margin-top: .3rem; font-weight: 600 !important; }
  .delta-up { color: #4ADE80 !important; } .delta-down { color: #F87171 !important; } .delta-neu { color: #94A3B8 !important; }

  /* Section headers */
  .section-header { font-size: 1.15rem !important; font-weight: 700 !important; color: #FFFFFF !important; border-left: 5px solid #3B82F6; padding: .3rem 0 .3rem 1rem; margin: 2rem 0 1rem 0; background: linear-gradient(90deg,rgba(59,130,246,.18),transparent); border-radius: 0 6px 6px 0; }

  /* Callout boxes - bright readable text */
  .story-box { background: rgba(59,130,246,.18); border: 1px solid rgba(59,130,246,.55); border-left: 5px solid #3B82F6; border-radius: 0 12px 12px 0; padding: 1.1rem 1.5rem; margin: .8rem 0 1.3rem; font-size: 1rem !important; color: #BFDBFE !important; line-height: 1.8 !important; font-weight: 400; }
  .insight-box { background: rgba(34,197,94,.15); border: 1px solid rgba(34,197,94,.45); border-left: 5px solid #22C55E; border-radius: 0 12px 12px 0; padding: 1.1rem 1.5rem; margin: .8rem 0 1.3rem; font-size: 1rem !important; color: #86EFAC !important; line-height: 1.8 !important; }
  .alert-box { background: rgba(239,68,68,.15); border: 1px solid rgba(239,68,68,.45); border-left: 5px solid #EF4444; border-radius: 0 12px 12px 0; padding: 1.1rem 1.5rem; margin: .8rem 0 1.3rem; font-size: 1rem !important; color: #FCA5A5 !important; line-height: 1.8 !important; }

  /* Sidebar */
  [data-testid="stSidebar"] { border-right: 2px solid #1E3A5F; }
  [data-testid="stSidebar"] [data-testid="stMarkdownContainer"] p { color: #94A3B8 !important; font-size: .85rem !important; }

  /* Sidebar navigation radio - LARGE and BRIGHT */
  [data-testid="stSidebar"] [data-testid="stRadio"] div[role="radiogroup"] label {
    color: #E2E8F0 !important; font-size: 1.05rem !important; font-weight: 500 !important;
    padding: .45rem .65rem !important; display: flex !important; align-items: center;
    border-radius: 8px !important; margin: 1px 0 !important;
  }
  [data-testid="stSidebar"] [data-testid="stRadio"] div[role="radiogroup"] label:hover {
    color: #FFFFFF !important; background: rgba(59,130,246,.25) !important;
  }
  [data-testid="stSidebar"] [data-testid="stRadio"] div[role="radiogroup"] label[data-checked="true"],
  [data-testid="stSidebar"] [data-testid="stRadio"] [aria-checked="true"] + div label {
    color: #60A5FA !important; font-weight: 700 !important; background: rgba(59,130,246,.2) !important;
  }

  /* Sidebar header */
  [data-testid="stSidebar"] h2, [data-testid="stSidebar"] .stMarkdown h2 { color: #FFFFFF !important; font-size: 1.15rem !important; font-weight: 800 !important; }

  /* Tabs */
  .stTabs [data-baseweb="tab-list"] { background: #0D1B3E; border-radius: 12px; padding: 5px; border: 2px solid #2D4A8A; gap: 5px; }
  .stTabs [data-baseweb="tab"] { color: #94A3B8 !important; font-size: .97rem !important; font-weight: 600 !important; border-radius: 8px !important; padding: .55rem 1.3rem !important; }
  .stTabs [data-baseweb="tab"]:hover { color: #E2E8F0 !important; background: rgba(59,130,246,.25) !important; }
  .stTabs [aria-selected="true"] { background: #3B82F6 !important; color: #FFFFFF !important; box-shadow: 0 2px 10px rgba(59,130,246,.5) !important; }
  .stTabs [aria-selected="true"] p { color: #FFFFFF !important; }

  /* Metric widget */
  div[data-testid="stMetricValue"] { font-size: 2rem !important; font-weight: 800 !important; color: #FFFFFF !important; }
  div[data-testid="stMetricLabel"] { font-size: .82rem !important; color: #94A3B8 !important; text-transform: uppercase; letter-spacing: .08em; font-weight: 700 !important; }
  div[data-testid="stMetricDelta"] svg { display: none; }

  /* Inputs */
  .stTextInput input, .stTextArea textarea { color: #F1F5F9 !important; font-size: 1rem !important; }
  .stTextInput label, .stTextArea label, .stSelectbox label,
  .stMultiSelect label, .stCheckbox label, .stSlider label { color: #CBD5E1 !important; font-size: .97rem !important; font-weight: 600 !important; }

  /* Select box value text */
  .stSelectbox div[data-baseweb="select"] span { color: #F1F5F9 !important; font-size: 1rem !important; }

  /* Expander */
  details summary, .streamlit-expanderHeader { color: #E2E8F0 !important; font-weight: 600 !important; font-size: 1rem !important; }

  /* Dataframe */
  [data-testid="stDataFrame"] th { color: #60A5FA !important; font-weight: 700 !important; font-size: .9rem !important; }
  [data-testid="stDataFrame"] td { color: #E2E8F0 !important; font-size: .9rem !important; }

  /* Divider */
  hr { border-color: #1E3A5F !important; margin: 1.5rem 0; }

  /* Primary button */
  [data-testid="baseButton-primary"] { background: linear-gradient(135deg,#2563EB,#1D4ED8) !important; color: #FFFFFF !important; font-weight: 700 !important; font-size: 1rem !important; border-radius: 10px !important; border: none !important; box-shadow: 0 4px 12px rgba(37,99,235,.4) !important; }
  [data-testid="baseButton-secondary"] { color: #E2E8F0 !important; border: 2px solid #2D4A8A !important; border-radius: 10px !important; }

  /* Download button */
  [data-testid="stDownloadButton"] button { background: linear-gradient(135deg,#059669,#047857) !important; color: #FFFFFF !important; font-weight: 700 !important; border: none !important; border-radius: 10px !important; }

  /* Slider ticks */
  [data-testid="stTickBar"] span { color: #94A3B8 !important; font-size: .82rem !important; }

  /* Warning/info/success boxes */
  [data-testid="stAlert"] { border-radius: 10px !important; }
  [data-testid="stAlert"] p { font-size: .97rem !important; font-weight: 500 !important; }
</style>
